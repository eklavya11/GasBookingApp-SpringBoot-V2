...
public class AddCustomerDto {
	...
	public String toString() {
		return "AddCustomerDto [userId=" + userId + ", username=" + username + ", password=" + password
				+ ", mobileNumber=" + mobileNumber + ", addessLine1=" + addessLine1 + ", addessLine2=" + addessLine2
				+ ", city=" + city + ", state=" + state + ", zipCode=" + zipCode + ", country=" + country + ", email="
				+ email + "]";
	}
